...
> - Họ có thể trở thành đối tác ở đâu?
> - Hai bên trao đổi giá trị gì với nhau?
> - Phần nào giao nhau hoặc cạnh tranh?
> - Điều gì là năng lực cốt lõi chúng ta phải tự giữ?

## 1. Điểm xuất phát của mô hình chúng ta

Mô hình không bắt đầu từ việc gọi tiền. Nó bắt đầu từ một **vấn đề, nhu cầu hoặc ý tưởng còn phân tán**, rồi giúp cộng đồng biến nó thành một dự án đủ rõ, đủ tin cậy và có khả năng thực hiện.

```text
Vấn đề / nhu cầu
→ Ý tưởng thô
→ Cộng đồng phản biện và bổ sung
→ Xác minh nhu cầu
→ Tạo đội dự án
...
→ Huy động nguồn lực
→ Thực hiện theo mốc
→ Công khai bằng chứng và kết quả
→ Mở rộng hoặc dừng
```

Nguồn lực không chỉ là tiền mà còn có thể là:

- Chuyên môn.
- Thời gian và nhân lực.
- Thiết bị hoặc cơ sở vật chất.
- Dữ liệu.
- Địa điểm thử nghiệm.
- Quan hệ chính sách.
- Đơn vị sản xuất.
...
> Không hỏi “tổ chức nào giống chúng ta nhất?” trước tiên. Hãy hỏi: **tổ chức đó đang nắm mắt xích nào mà chúng ta không cần tự xây lại?**

## 3. Cách đánh giá một tổ chức trong hệ sinh thái

Mỗi tổ chức cần được nhìn qua bảy câu hỏi:

1. Họ sở hữu tài sản gì?
2. Họ giải quyết nút thắt nào trong vòng đời dự án?
3. Họ cần đầu vào gì để vận hành tốt?
4. Chúng ta có thể cung cấp đầu vào đó không?
5. Chúng ta nhận lại được nguồn lực gì?
6. Phần nào hai bên cùng muốn sở hữu?
7. Điều gì chúng ta tuyệt đối không nên giao cho họ kiểm soát hoàn toàn?

Có thể phân loại quan hệ thành bốn vùng:

| Vùng quan hệ | Ý nghĩa |
|---|---|
| **Bổ sung** | Họ làm phần chúng ta không nên hoặc chưa cần tự xây |
| **Hợp tác** | Hai bên trao đổi nguồn lực và cùng tạo giá trị |
| **Giao nhau** | Hai bên có một số chức năng tương tự nhưng mục tiêu hoặc điểm bắt đầu khác nhau |
| **Cạnh tranh** | Hai bên cùng muốn sở hữu người dùng, dữ liệu, dòng dự án hoặc quyền quyết định |

Một tổ chức có thể đồng thời nằm trong cả bốn vùng.
